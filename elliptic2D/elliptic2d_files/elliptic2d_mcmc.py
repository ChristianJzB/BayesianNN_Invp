...
from elliptic2d_files.elliptic2d_neural import Elliptic2D
...
class EllipticMCMCDA(MCMCDA):
    ...
    def __init__(self, surrogate, finer_surrogate,observation_locations, observations_values, nparameters=2, 
        ...
        if marginal:
            methods = {EllipticPIGP: self.gp_marginal_model,
                        dgala: self.dgala_marginal_model}
        else:
            methods = {Elliptic2D_FEM: self.fem_model,
                        EllipticPIGP: self.gp_mean_model,
                        Elliptic2D: self.dgala_mean_model}
