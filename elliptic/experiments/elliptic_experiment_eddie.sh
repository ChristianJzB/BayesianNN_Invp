...
# # --- dgala Model configurations ---
Ns=(10 20 30 40 50 75 100 200 300 500 1000 3000 5000 7000 9000 10000 30000)
SMALL_BATCH=10                 # for N < 100
BIG_BATCHES=(500)     # for N ≥ 100 (you can add more)
NNEURONS=(60)
KLs=(2 3 4 5)
...
Ns=(1 2 3 4 5 10 15 20 25 30 35 40 45 50 60 65 75 100 125 150 160 170 180 190 200)
KLs=(2 3 4 5)
...
python elliptic/experiments/elliptic_models_experiment.py\
...
qsub -N "ell_PIGP_N${N}_KL${KL}" <<EOF
#!/bin/bash
#$ -cwd
#$ -q gpu
#$ -l gpu=1 
