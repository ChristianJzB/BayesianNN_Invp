...
from elliptic.experiments.experiments_utilities import *
...
if __name__ == "__main__":
    ...
    parser.add_argument("--kernel_spatial", type=str,default="Matern52", help="Fit DeepGala")
    parser.add_argument("--kernel_parameter", type=str,default="Matern52", help="Fit DeepGala")
    ...
    parser.add_argument("--num_neurons", type=int,default=60,help="Number of neurons/layer")
    ...
    if args.model_type == "pigp":
        config_model = elliptic_pigp_experiment(kernel_spatial = args.kernel_spatial,kernel_parameter=args.kernel_parameter,
                                                N=args.N,kl=args.kl,marginal = args.marginal_approximation)
    elif args.model_type == "gp":
        config_model = elliptic_gp_experiment(kernel=args.kernel_parameter,N= args.N,kl=args.kl,marginal = args.marginal_approximation)
    elif args.model_type == "dgala":
        config_model = elliptic_neural_training(args.N,args.hidden_layers,args.num_neurons,args.batch_size,args.kl,
    ...
    config_experiment = elliptic_inverse_problem(args.model_type,args.verbose,args.dgala,args.mcmc,args.da,
