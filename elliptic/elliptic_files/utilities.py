...
def pigp_training_data_generation(theta_obs,spatial_points_obs,kl_expansion, device,feval=10):

    #thetas = np.random.uniform(-3, 3, size=(theta_obs, kl_expansion))
    ...
    xf = torch.linspace(1e-3,0.99,feval).view(-1, 1)
